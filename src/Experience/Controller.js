...
export default class Controller {
    ...
    setVideoControls() {
        ...
        this.videoControls.tvScreen = async () => {
            if (this.resources.video['tvScreenVideoTexture'].paused) { this.resources.video['tvScreenVideoTexture'].play() }
            else {
        ...
        this.videoControls.smallScreen1 = async () => {
            if (this.smallScreen1Counter < this.resources.carousel1.length) { this.smallScreen1Counter++ }
        ...
        this.videoControls.smallScreen2 = async () => {
            if (this.smallScreen2Counter < this.resources.carousel2.length) { this.smallScreen2Counter++ }
